...
### 💡 Lab Name: Product Search for Marketing with BigQuery
...
```
bq load --source_format=CSV --skip_leading_rows=1 --autodetect products.products_information gs://bucket-name/products.csv
